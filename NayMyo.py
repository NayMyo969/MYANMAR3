...
def baliho():
	try:
		...
		print (logo)
		print (W + '     [' + G +'Nay Myo Facebook Information'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     Nay Myo (Bagyi Myo)
    Name       Facebook Information
    Version    Full Version
    Date       21/9/2020
    Blog       naymyo15689.blogspot.com
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + '[◆♤◆NAY MYO◆♤◆]' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + '[◆♤◆Nay Myo◆♤◆]' + W +'/' + R +'Bot ' '\033[92m>> ')
...
def main():
  ...
  try:
	cek = raw_input(R + '[◆♤◆Nay Myo◆♤◆]' + '\033[92m >> ')
